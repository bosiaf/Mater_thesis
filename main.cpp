...
int personal::v0, personal::h0, personal::hc_renew, personal::burst_size;
unsigned personal::seed;
string personal::path_to_tmat, personal::path_output_dyn, personal::path_output_seq, personal::seq0;
double personal::d_hc, personal::d_ic, personal::d_v, personal::k_inf, personal::S_df, personal::k_btw, personal::k_mut, personal::fit_snp, personal::fit_change, personal::k_fit;
...
int main(int argc, char * argv[])
{
	...
	//read in parameters, in mm^{-3} day{-1}
		read_pars(argv[1], MAX_TSTEP, path_to_tmat, path_output_dyn, path_output_seq, seq0, SNPs, v0, h0, hc_renew, d_hc, d_ic, burst_size, d_v, k_inf, S_df, k_btw, k_mut, fit_snp, fit_not_snp, weight_not_snp, dic_fit_dep, dv_fit_dep, inf_fit_dep, k_fit, ad_imm_sys, fit_change, seed);
	}
