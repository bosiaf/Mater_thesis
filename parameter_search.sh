...
INF_RATE_CONST=(5e-9 1e-8 4e-8 6.0e-8 9.0e-8 1.5e-7 4.0e-7 6.0e-7 9.0e-7 1.5e-6 2.5e-6 4.0e-6 6.0e-6 7.0e-6 9.0e-6 1.0e-5 1.2e-5 1.4e-5 1.7e-5 2.0e-5 2.3e-5 2.7e-5)
